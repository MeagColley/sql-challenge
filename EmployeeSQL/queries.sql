...
SELECT employees.first_name, employees.last_name, employees.emp_no, employees.gender, salaries.salary
FROM salaries
...
SELECT departments.dept_name, dept_manager.emp_no, employees.first_name, employees.last_name
FROM departments
INNER JOIN dept_manager ON departments.dept_no=dept_manager.dept_no
